...
var UnmarshalHandler = request.NamedHandler{Name: "byteplussdk.rest.Unmarshal", Fn: Unmarshal}

// UnmarshalMetaHandler is a named request handler for unmarshaling rest protocol request metadata
var UnmarshalMetaHandler = request.NamedHandler{Name: "byteplussdk.rest.UnmarshalMeta", Fn: UnmarshalMeta}
			...
			if ptag := pfield.Tag.Get("type"); ptag != "" && ptag != "structure" {
				...
				if payload.IsValid() {
					...
					case []byte:
						...
						if err != nil {
							r.Error = bytepluserr.New(request.ErrCodeSerialization, "failed to decode REST response", err)
						} else {
						...
						case "io.ReadSeeker":
							...
							if err != nil {
								r.Error = bytepluserr.New(request.ErrCodeSerialization,
									"failed to read response byteplusbody", err)
								return
							}
