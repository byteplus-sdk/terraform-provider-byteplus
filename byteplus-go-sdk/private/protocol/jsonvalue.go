...
func EncodeJSONValue(v byteplus.JSONValue, escape EscapeMode) (string, error) {
...
//
// Will panic if the escape mode is unknown.
func DecodeJSONValue(v string, escape EscapeMode) (byteplus.JSONValue, error) {
	var b []byte
	var err error
