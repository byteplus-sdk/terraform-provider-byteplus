...
// OrigErr returns the invalid parameters as a bytepluserr.BatchedErrors value
func (e ErrInvalidParams) OrigErr() error {
	return bytepluserr.NewBatchError(
...
// OrigErr returns nil, Implemented for bytepluserr.Error interface.
