...
// A Value is the byteplus credentials value for individual credential fields.
type Value struct {
...
// A Credentials provides concurrency safe retrieval of byteplus credentials Value.
...
func (c *Credentials) ExpiresAt() (time.Time, error) {
	...
	if !ok {
		return time.Time{}, bytepluserr.New("ProviderNotExpirer",
