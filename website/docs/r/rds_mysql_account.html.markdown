...
layout: "byteplus"
page_title: "Byteplus: byteplus_rds_mysql_account"
sidebar_current: "docs-byteplus-resource-rds_mysql_account"
description: |-
  Provides a resource to manage rds mysql account
---
# byteplus_rds_mysql_account
Provides a resource to manage rds mysql account
## Example Usage
```hcl
...
resource "byteplus_rds_mysql_database" "foo1" {
...
resource "byteplus_rds_mysql_account" "foo" {
  ...
  account_privileges {
    db_name           = byteplus_rds_mysql_database.foo1.db_name
