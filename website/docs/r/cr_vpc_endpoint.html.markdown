...
subcategory: "CR"
layout: "byteplus"
page_title: "Byteplus: byteplus_cr_vpc_endpoint"
sidebar_current: "docs-byteplus-resource-cr_vpc_endpoint"
description: |-
  Provides a resource to manage cr vpc endpoint
---
# byteplus_cr_vpc_endpoint
Provides a resource to manage cr vpc endpoint
## Example Usage
```hcl
resource "byteplus_cr_vpc_endpoint" "foo" {
