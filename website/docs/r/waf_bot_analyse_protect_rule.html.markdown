...
subcategory: "WAF"
layout: "byteplus"
page_title: "Byteplus: byteplus_waf_bot_analyse_protect_rule"
sidebar_current: "docs-byteplus-resource-waf_bot_analyse_protect_rule"
description: |-
  Provides a resource to manage waf bot analyse protect rule
---
# byteplus_waf_bot_analyse_protect_rule
Provides a resource to manage waf bot analyse protect rule
## Example Usage
```hcl
resource "byteplus_waf_bot_analyse_protect_rule" "foo" {
