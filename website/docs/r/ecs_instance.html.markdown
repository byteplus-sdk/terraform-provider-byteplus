...
subcategory: "ECS"
layout: "byteplus"
page_title: "Byteplus: byteplus_ecs_instance"
sidebar_current: "docs-byteplus-resource-ecs_instance"
description: |-
...
* `security_enhancement_strategy` - (Optional, ForceNew) The security enhancement strategy of ECS instance. The value can be Active or InActibp. Default is Actibp.When importing resources, this attribute will not be imported. If this attribute is set, please use lifecycle and ignore_changes ignore changes in fields.
...
* `spot_strategy` - (Optional, ForceNew) The spot strategy will autoremove instance in some conditions.Please make sure you can maintain instance lifecycle before auto remobp.The spot strategy of ECS instance, values:
