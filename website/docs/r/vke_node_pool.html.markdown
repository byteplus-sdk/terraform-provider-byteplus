...
subcategory: "VKE"
layout: "byteplus"
page_title: "Byteplus: byteplus_vke_node_pool"
sidebar_current: "docs-byteplus-resource-vke_node_pool"
description: |-
...
* `instance_type_ids` - (Required) The InstanceTypeIds of NodeConfig. The value can get from byteplus_vke_support_resource_types datasource.
