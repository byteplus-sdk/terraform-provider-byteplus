...
layout: "byteplus"
page_title: "Byteplus: byteplus_cloud_monitor_rules"
sidebar_current: "docs-byteplus-datasource-cloud_monitor_rules"
description: |-
  Use this data source to query detailed information of cloud monitor rules
---
# byteplus_cloud_monitor_rules
Use this data source to query detailed information of cloud monitor rules
## Example Usage
```hcl
data "byteplus_cloud_monitor_rules" "foo" {
  ids       = ["189968992874863****"]
  namespace = ["VCM_ECS"]
}
```
...
* `rules` - The collection of query.
    ...
    * `level_conditions` - The level conditions of the cloud monitor rule.
        * `conditions` - The conditions of the cloud monitor rule.
            * `comparison_operator` - The comparison operation of the cloud monitor rule.
            * `metric_name` - The metric name of the cloud monitor rule.
            * `metric_unit` - The metric unit of the cloud monitor rule.
    ...
    * `no_data` - No-data alarm.
        * `enable` - Specifies whether to enable no-data alarm.
        * `evaluation_count` - No data alarm triggering threshold.
    * `notification_id` - The notification id of the cloud monitor rule.
    * `notify_mode` - Alarm sending aggregation strategy.
    * `original_dimensions` - The original dimensions of the cloud monitor rule.
        * `key` - The key of the dimension.
        * `value` - The value of the dimension.
    * `project_name` - The project name of the cloud monitor rule.
