...
const testAccByteplusCenBandwidthPackageAssociateCreateConfig = `
...
func TestAccByteplusCenBandwidthPackageAssociateResource_Basic(t *testing.T) {
	resourceName := "byteplus_cen_bandwidth_package_associate.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusCenBandwidthPackageAssociateCreateConfig,
