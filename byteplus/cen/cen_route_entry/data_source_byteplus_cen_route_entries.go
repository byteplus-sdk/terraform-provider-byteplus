...
func DataSourceByteplusCenRouteEntries() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusCenRouteEntriesRead,
...
func dataSourceByteplusCenRouteEntriesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCenRouteEntryService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusCenRouteEntries())
}
