...
const testAccByteplusCenRouteEntriesDatasourceConfig = `
...
func TestAccByteplusCenRouteEntriesDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_cen_route_entries.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusCenRouteEntriesDatasourceConfig,
