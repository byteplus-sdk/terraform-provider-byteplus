...
func DataSourceByteplusCenServiceRouteEntries() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusCenServiceRouteEntriesRead,
...
func dataSourceByteplusCenServiceRouteEntriesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCenServiceRouteEntryService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusCenServiceRouteEntries())
}
