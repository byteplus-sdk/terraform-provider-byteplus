...
func DataSourceByteplusCenAttachInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusCenInstanceAttachInstances,
...
func dataSourceByteplusCenInstanceAttachInstances(d *schema.ResourceData, meta interface{}) error {
	cenAttachInstanceService := NewCenAttachInstanceService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(cenAttachInstanceService, d, DataSourceByteplusCenAttachInstances())
}
