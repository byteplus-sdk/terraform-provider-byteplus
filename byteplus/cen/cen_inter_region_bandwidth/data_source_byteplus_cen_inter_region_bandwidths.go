...
func DataSourceByteplusCenInterRegionBandwidths() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusCenInterRegionBandwidthsRead,
...
func dataSourceByteplusCenInterRegionBandwidthsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCenInterRegionBandwidthService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusCenInterRegionBandwidths())
}
