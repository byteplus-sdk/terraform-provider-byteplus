...
func DataSourceByteplusCenBandwidthPackages() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusCenBandwidthPackagesRead,
...
func dataSourceByteplusCenBandwidthPackagesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCenBandwidthPackageService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusCenBandwidthPackages())
}
