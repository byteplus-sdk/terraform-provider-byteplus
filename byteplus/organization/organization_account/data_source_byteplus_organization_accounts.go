...
func DataSourceByteplusOrganizationAccounts() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusOrganizationAccountsRead,
...
func dataSourceByteplusOrganizationAccountsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewOrganizationAccountService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusOrganizationAccounts())
}
