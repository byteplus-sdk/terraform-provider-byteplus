...
func DataSourceByteplusOrganizationUnits() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusOrganizationUnitsRead,
...
func dataSourceByteplusOrganizationUnitsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewOrganizationUnitService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusOrganizationUnits())
}
