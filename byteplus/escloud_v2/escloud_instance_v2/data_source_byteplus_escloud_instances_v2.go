...
func DataSourceByteplusEscloudInstanceV2s() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusEscloudInstanceV2sRead,
...
func dataSourceByteplusEscloudInstanceV2sRead(d *schema.ResourceData, meta interface{}) error {
	service := NewEscloudInstanceV2Service(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusEscloudInstanceV2s())
}
