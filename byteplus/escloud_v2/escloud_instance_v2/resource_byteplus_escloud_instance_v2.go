...
func ResourceByteplusEscloudInstanceV2() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusEscloudInstanceV2Create,
		Read:   resourceByteplusEscloudInstanceV2Read,
		Update: resourceByteplusEscloudInstanceV2Update,
		Delete: resourceByteplusEscloudInstanceV2Delete,
...
func resourceByteplusEscloudInstanceV2Create(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewEscloudInstanceV2Service(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusEscloudInstanceV2())
	if err != nil {
		return fmt.Errorf("error on creating escloud_instance_v2 %q, %s", d.Id(), err)
	}
	return resourceByteplusEscloudInstanceV2Read(d, meta)
}

func resourceByteplusEscloudInstanceV2Read(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewEscloudInstanceV2Service(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusEscloudInstanceV2())
	if err != nil {
...
func resourceByteplusEscloudInstanceV2Update(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewEscloudInstanceV2Service(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusEscloudInstanceV2())
	if err != nil {
...
func resourceByteplusEscloudInstanceV2Delete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewEscloudInstanceV2Service(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusEscloudInstanceV2())
	if err != nil {
