...
func DataSourceByteplusBandwidthPackages() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusBandwidthPackagesRead,
...
func dataSourceByteplusBandwidthPackagesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewBandwidthPackageService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusBandwidthPackages())
}
