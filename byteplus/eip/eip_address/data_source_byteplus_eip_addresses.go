...
func DataSourceByteplusEipAddresses() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusEipAddressesRead,
...
func dataSourceByteplusEipAddressesRead(d *schema.ResourceData, meta interface{}) error {
	eipAddressService := NewEipAddressService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(eipAddressService, d, DataSourceByteplusEipAddresses())
}
