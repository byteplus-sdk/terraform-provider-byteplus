...
func DataSourceByteplusScalingPolicies() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusScalingPoliciesRead,
...
func dataSourceByteplusScalingPoliciesRead(d *schema.ResourceData, meta interface{}) error {
	scalingPolicyService := NewScalingPolicyService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(scalingPolicyService, d, DataSourceByteplusScalingPolicies())
}
