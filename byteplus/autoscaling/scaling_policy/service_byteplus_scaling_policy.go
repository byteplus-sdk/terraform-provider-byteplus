...
type ByteplusScalingPolicyService struct {
	Client *bp.SdkClient
}

func NewScalingPolicyService(c *bp.SdkClient) *ByteplusScalingPolicyService {
	return &ByteplusScalingPolicyService{
		Client: c,
	}
}
...
func (s *ByteplusScalingPolicyService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	...
	return bp.WithPageNumberQuery(m, "PageSize", "PageNumber", 20, 1, func(condition map[string]interface{}) ([]interface{}, error) {
		...
		results, err = bp.ObtainSdkValue("Result.ScalingPolicies", *resp)
		if err != nil {
			return data, err
		}
		if results == nil {
...
func (ByteplusScalingPolicyService) WithResourceResponseHandlers(scalingPolicy map[string]interface{}) []bp.ResourceResponseHandler {
	handler := func() (map[string]interface{}, map[string]bp.ResponseConvert, error) {
		...
		return scalingPolicy, map[string]bp.ResponseConvert{
...
func (s *ByteplusScalingPolicyService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	...
	// 创建伸缩规则
	createPolicyCallback := bp.Callback{
		Call: bp.SdkCall{
			...
			AfterCall: func(d *schema.ResourceData, client *bp.SdkClient, resp *map[string]interface{}, call bp.SdkCall) error {
				...
				id, _ := bp.ObtainSdkValue("Result.ScalingPolicyId", *resp)
...
func (s *ByteplusScalingPolicyService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	...
	// 修改伸缩规则属性
	modifyScalingPolicyCallback := bp.Callback{
		Call: bp.SdkCall{
...
func (s *ByteplusScalingPolicyService) enableOrDisablePolicyCallback(resourceData *schema.ResourceData) bp.Callback {
