package scaling_instance_attachment_test
...
const testAccByteplusScalingInstanceAttachmentCreateConfig = `
...
func TestAccByteplusScalingInstanceAttachmentResource_Basic(t *testing.T) {
	resourceName := "byteplus_scaling_instance_attachment.foo"

	acc := &byteplus.AccTestResource{
		ResourceId: resourceName,
		Svc:        &scaling_instance_attachment.ByteplusScalingInstanceAttachmentService{},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusScalingInstanceAttachmentCreateConfig,
				Check: resource.ComposeTestCheckFunc(
					byteplus.AccTestCheckResourceExists(acc),
					resource.TestCheckResourceAttr(acc.ResourceId, "entrusted", "true"),
				),
			},
			{
