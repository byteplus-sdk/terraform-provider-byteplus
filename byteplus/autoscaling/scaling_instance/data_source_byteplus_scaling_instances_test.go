...
const testAccByteplusScalingInstancesDatasourceConfig = `
...
func TestAccByteplusScalingInstancesDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_scaling_instances.foo"

	acc := &byteplus.AccTestResource{
		ResourceId: resourceName,
		Svc:        &scaling_instance.ByteplusScalingInstanceService{},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusScalingInstancesDatasourceConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(acc.ResourceId, "scaling_instances.#", "3"),
				),
			},
		},
	})
