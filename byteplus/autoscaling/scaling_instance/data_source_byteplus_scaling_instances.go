...
func DataSourceByteplusScalingInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusScalingInstancesRead,
...
func dataSourceByteplusScalingInstancesRead(d *schema.ResourceData, meta interface{}) error {
	scalingInstanceService := NewScalingInstanceService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(scalingInstanceService, d, DataSourceByteplusScalingInstances())
}
