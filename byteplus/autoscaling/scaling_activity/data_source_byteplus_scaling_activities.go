...
func DataSourceByteplusScalingActivities() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusScalingActivitiesRead,
...
func dataSourceByteplusScalingActivitiesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewScalingActivityService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusScalingActivities())
}
