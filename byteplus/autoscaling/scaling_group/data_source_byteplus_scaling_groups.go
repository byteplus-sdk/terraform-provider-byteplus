...
func DataSourceByteplusScalingGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusScalingGroupsRead,
...
func dataSourceByteplusScalingGroupsRead(d *schema.ResourceData, meta interface{}) error {
	scalingGroupService := NewScalingGroupService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(scalingGroupService, d, DataSourceByteplusScalingGroups())
}
