...
const testAccByteplusScalingGroupEnablerCreateConfig = `
...
func TestAccByteplusScalingGroupEnablerResource_Basic(t *testing.T) {
	resourceName := "byteplus_scaling_group_enabler.foo"

	acc := &byteplus.AccTestResource{
		ResourceId: resourceName,
		Svc:        &scaling_group_enabler.ByteplusScalingGroupEnablerService{},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusScalingGroupEnablerCreateConfig,
