...
func ResourceByteplusCdnSharedConfig() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusCdnSharedConfigCreate,
		Read:   resourceByteplusCdnSharedConfigRead,
		Update: resourceByteplusCdnSharedConfigUpdate,
		Delete: resourceByteplusCdnSharedConfigDelete,
...
func resourceByteplusCdnSharedConfigCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewCdnSharedConfigService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusCdnSharedConfig())
	if err != nil {
		return fmt.Errorf("error on creating cdn_shared_config %q, %s", d.Id(), err)
	}
	return resourceByteplusCdnSharedConfigRead(d, meta)
}

func resourceByteplusCdnSharedConfigRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewCdnSharedConfigService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusCdnSharedConfig())
	if err != nil {
...
func resourceByteplusCdnSharedConfigUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewCdnSharedConfigService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusCdnSharedConfig())
	if err != nil {
...
func resourceByteplusCdnSharedConfigDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewCdnSharedConfigService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusCdnSharedConfig())
	if err != nil {
