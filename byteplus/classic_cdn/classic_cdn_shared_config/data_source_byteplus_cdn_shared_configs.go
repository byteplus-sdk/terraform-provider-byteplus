...
func DataSourceByteplusCdnSharedConfigs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusCdnSharedConfigsRead,
...
func dataSourceByteplusCdnSharedConfigsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCdnSharedConfigService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusCdnSharedConfigs())
}
