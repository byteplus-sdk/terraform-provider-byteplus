...
func DataSourceByteplusInstanceSpecs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusInstanceSpecsRead,
...
func dataSourceByteplusInstanceSpecsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewInstanceSpecService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusInstanceSpecs())
}
