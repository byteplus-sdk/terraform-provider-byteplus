...
const testAccByteplusRedisAccountsDatasourceConfig = `
...
func TestAccByteplusRedisAccountsDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_redis_accounts.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusRedisAccountsDatasourceConfig,
