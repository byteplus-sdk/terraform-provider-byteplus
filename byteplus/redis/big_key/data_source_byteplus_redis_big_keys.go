...
func DataSourceByteplusBigKeys() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusBigKeysRead,
...
func dataSourceByteplusBigKeysRead(d *schema.ResourceData, meta interface{}) error {
	service := NewBigKeyService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusBigKeys())
}
