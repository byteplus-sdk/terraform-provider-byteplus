...
func DataSourceByteplusRedisBackups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRedisBackupsRead,
...
func dataSourceByteplusRedisBackupsRead(d *schema.ResourceData, meta interface{}) error {
	redisBackupService := NewRedisBackupService(meta.(*bp.SdkClient))
	err := bp.DefaultDispatcher().Data(redisBackupService, d, DataSourceByteplusRedisBackups())
	return err
}
