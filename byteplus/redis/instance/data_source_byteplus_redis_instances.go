...
func DataSourceByteplusRedisDbInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRedisDbInstancesRead,
...
func dataSourceByteplusRedisDbInstancesRead(d *schema.ResourceData, meta interface{}) error {
	redisInstanceService := NewRedisDbInstanceService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(redisInstanceService, d, DataSourceByteplusRedisDbInstances())
}
