...
func DataSourceByteplusParameterGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusParameterGroupsRead,
...
func dataSourceByteplusParameterGroupsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewParameterGroupService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusParameterGroups())
}
