...
const testAccByteplusRedisAllowListsDatasourceConfig = `
...
func TestAccByteplusRedisAllowListsDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_redis_allow_lists.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusRedisAllowListsDatasourceConfig,
