...
func DataSourceByteplusRedisAllowLists() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRedisAllowListRead,
...
func dataSourceByteplusRedisAllowListRead(d *schema.ResourceData, meta interface{}) error {
	redisAllowListService := NewRedisAllowListService(meta.(*bp.SdkClient))
	err := bp.DefaultDispatcher().Data(redisAllowListService, d, DataSourceByteplusRedisAllowLists())
	return err
}
