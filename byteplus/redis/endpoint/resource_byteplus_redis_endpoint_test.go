...
import (
	...
	"github.com/byteplus-sdk/terraform-provider-byteplus/byteplus/redis/endpoint"
	bp "github.com/byteplus-sdk/terraform-provider-byteplus/common"
	"github.com/hashicorp/terraform-plugin-sdk/helper/resource"
)

const testAccByteplusRedisEndpointCreateConfig = `
...
func TestAccByteplusRedisEndpointResource_Basic(t *testing.T) {
	resourceName := "byteplus_redis_endpoint.foo"

	acc := &byteplus.AccTestResource{
		ResourceId: resourceName,
		SvcInitFunc: func(client *bp.SdkClient) bp.ResourceService {
			return endpoint.NewRedisEndpointService(client)
		},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusRedisEndpointCreateConfig,
