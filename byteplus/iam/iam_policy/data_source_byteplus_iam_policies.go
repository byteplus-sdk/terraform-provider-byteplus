...
func DataSourceByteplusIamPolicies() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusIamPoliciesRead,
...
func dataSourceByteplusIamPoliciesRead(d *schema.ResourceData, meta interface{}) error {
	iamPolicyService := NewIamPolicyService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(iamPolicyService, d, DataSourceByteplusIamPolicies())
}
