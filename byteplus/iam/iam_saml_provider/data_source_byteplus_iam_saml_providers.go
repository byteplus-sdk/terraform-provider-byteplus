...
func DataSourceByteplusIamSamlProviders() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusIamSamlProvidersRead,
...
func dataSourceByteplusIamSamlProvidersRead(d *schema.ResourceData, meta interface{}) error {
	service := NewIamSamlProviderService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusIamSamlProviders())
}
