...
type ByteplusVolumeAttachService struct {
	Client        *bp.SdkClient
	volumeService *volume.ByteplusVolumeService
}

func NewVolumeAttachService(c *bp.SdkClient) *ByteplusVolumeAttachService {
	return &ByteplusVolumeAttachService{
		Client:        c,
		volumeService: volume.NewVolumeService(c),
	}
}

func (s *ByteplusVolumeAttachService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *ByteplusVolumeAttachService) ReadResources(condition map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *ByteplusVolumeAttachService) ReadResource(resourceData *schema.ResourceData, volumeAttachId string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *ByteplusVolumeAttachService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (ByteplusVolumeAttachService) WithResourceResponseHandlers(volume map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *ByteplusVolumeAttachService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
...
func (s *ByteplusVolumeAttachService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []bp.Callback {
...
func (s *ByteplusVolumeAttachService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	return []bp.Callback{}
}

func (s *ByteplusVolumeAttachService) DatasourceResources(*schema.ResourceData, *schema.Resource) bp.DataSourceInfo {
...
func (s *ByteplusVolumeAttachService) ReadResourceId(id string) string {
	return id
}
