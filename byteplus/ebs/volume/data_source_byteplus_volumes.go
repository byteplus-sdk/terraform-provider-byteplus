...
func DataSourceByteplusVolumes() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusVolumesRead,
...
func dataSourceByteplusVolumesRead(d *schema.ResourceData, meta interface{}) error {
	volumeService := NewVolumeService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(volumeService, d, DataSourceByteplusVolumes())
}
