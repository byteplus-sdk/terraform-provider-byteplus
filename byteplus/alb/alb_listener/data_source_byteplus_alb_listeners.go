...
func DataSourceByteplusListeners() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusAlbListenersRead,
...
func dataSourceByteplusAlbListenersRead(d *schema.ResourceData, meta interface{}) error {
	listenerService := NewAlbListenerService(meta.(*bp.SdkClient))
	return listenerService.Dispatcher.Data(listenerService, d, DataSourceByteplusListeners())
}
