...
func DataSourceByteplusAlbHealthCheckTemplates() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusAlbHealthCheckTemplatesRead,
...
func dataSourceByteplusAlbHealthCheckTemplatesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewAlbHealthCheckTemplateService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusAlbHealthCheckTemplates())
}
