...
func ResourceByteplusAlbServerGroup() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusAlbServerGroupCreate,
		Read:   resourceByteplusAlbServerGroupRead,
		Update: resourceByteplusAlbServerGroupUpdate,
		Delete: resourceByteplusAlbServerGroupDelete,
...
func resourceByteplusAlbServerGroupCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewAlbServerGroupService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusAlbServerGroup())
	if err != nil {
		return fmt.Errorf("error on creating alb_server_group %q, %s", d.Id(), err)
	}
	return resourceByteplusAlbServerGroupRead(d, meta)
}

func resourceByteplusAlbServerGroupRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewAlbServerGroupService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusAlbServerGroup())
	if err != nil {
...
func resourceByteplusAlbServerGroupUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewAlbServerGroupService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusAlbServerGroup())
	if err != nil {
...
func resourceByteplusAlbServerGroupDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewAlbServerGroupService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusAlbServerGroup())
	if err != nil {
