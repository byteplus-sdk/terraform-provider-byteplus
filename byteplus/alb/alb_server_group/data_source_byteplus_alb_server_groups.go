...
func DataSourceByteplusAlbServerGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusAlbServerGroupsRead,
...
func dataSourceByteplusAlbServerGroupsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewAlbServerGroupService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusAlbServerGroups())
}
