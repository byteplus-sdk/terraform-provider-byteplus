...
func DataSourceByteplusAlbCustomizedCfgs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusAlbCustomizedCfgsRead,
...
func dataSourceByteplusAlbCustomizedCfgsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewAlbCustomizedCfgService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusAlbCustomizedCfgs())
}
