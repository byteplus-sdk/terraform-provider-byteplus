...
func DataSourceByteplusAlbCaCertificates() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusAlbCaCertificatesRead,
...
func dataSourceByteplusAlbCaCertificatesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewAlbCaCertificateService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusAlbCaCertificates())
}
