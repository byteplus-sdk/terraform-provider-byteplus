...
func DataSourceByteplusAlbAcls() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusAlbAclsRead,
...
func dataSourceByteplusAlbAclsRead(d *schema.ResourceData, meta interface{}) error {
	aclService := NewAclService(meta.(*bp.SdkClient))
	return aclService.Dispatcher.Data(aclService, d, DataSourceByteplusAlbAcls())
}
