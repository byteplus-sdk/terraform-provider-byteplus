...
func DataSourceByteplusAlbs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusAlbsRead,
...
func dataSourceByteplusAlbsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewAlbService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusAlbs())
}
