...
func DataSourceByteplusAlbRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusAlbRulesRead,
...
func dataSourceByteplusAlbRulesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewAlbRuleService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusAlbRules())
}
