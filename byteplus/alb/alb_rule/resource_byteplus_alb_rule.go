...
func ResourceByteplusAlbRule() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusAlbRuleCreate,
		Read:   resourceByteplusAlbRuleRead,
		Update: resourceByteplusAlbRuleUpdate,
		Delete: resourceByteplusAlbRuleDelete,
...
func resourceByteplusAlbRuleCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewAlbRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusAlbRule())
	if err != nil {
		return fmt.Errorf("error on creating alb_rule %q, %s", d.Id(), err)
	}
	return resourceByteplusAlbRuleRead(d, meta)
}

func resourceByteplusAlbRuleRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewAlbRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusAlbRule())
	if err != nil {
...
func resourceByteplusAlbRuleUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewAlbRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusAlbRule())
	if err != nil {
...
func resourceByteplusAlbRuleDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewAlbRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusAlbRule())
	if err != nil {
