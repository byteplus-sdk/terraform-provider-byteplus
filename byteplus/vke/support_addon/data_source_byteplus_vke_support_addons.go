...
func DataSourceByteplusVkeVkeSupportedAddons() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusVkeSupportAddonsRead,
...
func dataSourceByteplusVkeSupportAddonsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewVkeSupportAddonService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusVkeVkeSupportedAddons())
}
