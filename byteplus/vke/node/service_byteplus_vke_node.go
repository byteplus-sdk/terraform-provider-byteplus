...
type ByteplusVkeNodeService struct {
	Client          *bp.SdkClient
	nodePoolService *node_pool.ByteplusNodePoolService
}

func NewByteplusVkeNodeService(c *bp.SdkClient) *ByteplusVkeNodeService {
	return &ByteplusVkeNodeService{
		Client:          c,
		nodePoolService: node_pool.NewNodePoolService(c),
	}
}

func (s *ByteplusVkeNodeService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *ByteplusVkeNodeService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *ByteplusVkeNodeService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *ByteplusVkeNodeService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (ByteplusVkeNodeService) WithResourceResponseHandlers(nodes map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *ByteplusVkeNodeService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
...
func (s *ByteplusVkeNodeService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	return []bp.Callback{}
}

func (s *ByteplusVkeNodeService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []bp.Callback {
	callback := bp.Callback{
		Call: bp.SdkCall{
			Action:      "DeleteNodes",
...
func (s *ByteplusVkeNodeService) DatasourceResources(*schema.ResourceData, *schema.Resource) bp.DataSourceInfo {
...
func (s *ByteplusVkeNodeService) ReadResourceId(id string) string {
	return id
}
