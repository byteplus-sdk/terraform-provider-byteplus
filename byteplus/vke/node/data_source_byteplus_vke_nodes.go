...
func DataSourceByteplusVkeNodes() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusVkeNodesRead,
...
func dataSourceByteplusVkeNodesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewByteplusVkeNodeService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusVkeNodes())
}
