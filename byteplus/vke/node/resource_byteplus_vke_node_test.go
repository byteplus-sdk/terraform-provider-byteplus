...
const testAccByteplusVkeNodeCreateConfig = `
...
func TestAccByteplusVkeNodeResource_Basic(t *testing.T) {
	resourceName := "byteplus_vke_node.foo"

	acc := &byteplus.AccTestResource{
		ResourceId: resourceName,
		SvcInitFunc: func(client *bp.SdkClient) bp.ResourceService {
			return node.NewByteplusVkeNodeService(client)
		},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusVkeNodeCreateConfig,
...
const testAccByteplusVkeNodeCreateDefaultNodePoolConfig = `
data "byteplus_zones" "foo"{
}
...
resource "byteplus_vke_node" "foo" {
	...
	depends_on = ["byteplus_vke_default_node_pool.foo"]
}
`

func TestAccByteplusVkeNodeResource_DefaultNodePool(t *testing.T) {
	resourceName := "byteplus_vke_node.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusVkeNodeCreateDefaultNodePoolConfig,
				Check: resource.ComposeTestCheckFunc(
					byteplus.AccTestCheckResourceExists(acc),
					resource.TestCheckResourceAttr(acc.ResourceId, "additional_container_storage_enabled", "false"),
					resource.TestCheckResourceAttr(acc.ResourceId, "container_storage_path", ""),
