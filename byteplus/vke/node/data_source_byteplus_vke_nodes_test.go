...
const testAccByteplusVkeNodesDatasourceConfig = `
...
func TestAccByteplusVkeNodesDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_vke_nodes.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusVkeNodesDatasourceConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(acc.ResourceId, "nodes.#", "2"),
				),
			},
		},
	})
