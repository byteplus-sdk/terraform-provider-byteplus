...
```
$ terraform import byteplus_vke_default_node.default nc5t5epmrsf****
```

*/

func ResourceByteplusDefaultNodePool() *schema.Resource {
	return &schema.Resource{
		Create: resourceByteplusDefaultNodePoolCreate,
		Update: resourceByteplusDefaultNodePoolUpdate,
		Read:   resourceByteplusDefaultNodePoolRead,
		Delete: resourceByteplusNodePoolDelete,
...
func resourceByteplusDefaultNodePoolCreate(d *schema.ResourceData, meta interface{}) (err error) {
	nodePoolService := NewDefaultNodePoolService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Create(nodePoolService, d, ResourceByteplusDefaultNodePool())
	if err != nil {
		return fmt.Errorf("error on creating DefaultNodePool  %q, %w", d.Id(), err)
	}
	return resourceByteplusDefaultNodePoolRead(d, meta)
}

func resourceByteplusDefaultNodePoolRead(d *schema.ResourceData, meta interface{}) (err error) {
	nodePoolService := NewDefaultNodePoolService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(nodePoolService, d, ResourceByteplusDefaultNodePool())
	if err != nil {
...
func resourceByteplusDefaultNodePoolUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	nodePoolService := NewDefaultNodePoolService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Update(nodePoolService, d, ResourceByteplusDefaultNodePool())
	if err != nil {
...
func resourceByteplusNodePoolDelete(d *schema.ResourceData, meta interface{}) (err error) {
	nodePoolService := NewDefaultNodePoolService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(nodePoolService, d, ResourceByteplusDefaultNodePool())
	if err != nil {
