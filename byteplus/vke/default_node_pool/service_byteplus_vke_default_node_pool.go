...
import (
	...
	"github.com/byteplus-sdk/terraform-provider-byteplus/byteplus/vke"
...
type ByteplusDefaultNodePoolService struct {
	Client          *bp.SdkClient
	nodePoolService *node_pool.ByteplusNodePoolService
	nodeService     *node.ByteplusVkeNodeService
}

func NewDefaultNodePoolService(c *bp.SdkClient) *ByteplusDefaultNodePoolService {
	return &ByteplusDefaultNodePoolService{
		Client:          c,
		nodePoolService: node_pool.NewNodePoolService(c),
		nodeService:     node.NewByteplusVkeNodeService(c),
	}
}
...
func (s *ByteplusDefaultNodePoolService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *ByteplusDefaultNodePoolService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	return data, err
}

func (s *ByteplusDefaultNodePoolService) ReadResource(resourceData *schema.ResourceData, nodePoolId string) (data map[string]interface{}, err error) {
	var (
		nodes []interface{}
	)
	if nodePoolId == "" {
	...
	data["Instances"] = ins
	logger.Debug(logger.RespFormat, "ByteplusDefaultNodePoolService result ", data)

	return data, err
}

func (s *ByteplusDefaultNodePoolService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (s *ByteplusDefaultNodePoolService) WithResourceResponseHandlers(nodePool map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *ByteplusDefaultNodePoolService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
...
func (s *ByteplusDefaultNodePoolService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	var calls []bp.Callback
	// 先修改节点池配置
...
func (s *ByteplusDefaultNodePoolService) RemoveResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	callback := bp.Callback{
		Call: bp.SdkCall{
...
func (ByteplusDefaultNodePoolService) DatasourceResources(data *schema.ResourceData, resource *schema.Resource) bp.DataSourceInfo {
	return bp.DataSourceInfo{}
}

func (s *ByteplusDefaultNodePoolService) ReadResourceId(id string) string {
	return id
}
...
func (s *ByteplusDefaultNodePoolService) ProcessNodeInstances(resourceData *schema.ResourceData, calls []bp.Callback) []bp.Callback {
...
func (s *ByteplusDefaultNodePoolService) setResourceTags(resourceData *schema.ResourceData, resourceType string, callbacks []bp.Callback) []bp.Callback {
