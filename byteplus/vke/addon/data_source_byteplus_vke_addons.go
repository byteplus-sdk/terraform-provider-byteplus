...
func DataSourceByteplusVkeAddons() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusVkeAddonsRead,
...
func dataSourceByteplusVkeAddonsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewVkeAddonService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusVkeAddons())
}
