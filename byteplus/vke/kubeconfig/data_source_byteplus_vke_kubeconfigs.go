...
func DataSourceByteplusVkeKubeconfigs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusVkeKubeconfigsRead,
...
func dataSourceByteplusVkeKubeconfigsRead(d *schema.ResourceData, meta interface{}) (err error) {
	kubeconfigService := NewVkeKubeconfigService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(kubeconfigService, d, DataSourceByteplusVkeKubeconfigs())
}
