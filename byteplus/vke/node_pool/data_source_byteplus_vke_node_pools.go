...
func DataSourceByteplusNodePools() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusNodePoolsRead,
...
func dataSourceByteplusNodePoolsRead(d *schema.ResourceData, meta interface{}) error {
	nodePoolsService := NewNodePoolService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(nodePoolsService, d, DataSourceByteplusNodePools())
}
