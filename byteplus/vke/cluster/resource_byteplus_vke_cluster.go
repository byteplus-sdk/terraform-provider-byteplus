...
func ResourceByteplusVkeCluster() *schema.Resource {
	return &schema.Resource{
		Create: resourceByteplusVkeClusterCreate,
		Read:   resourceByteplusVkeClusterRead,
		Update: resourceByteplusVkeClusterUpdate,
		Delete: resourceByteplusVkeClusterDelete,
...
func resourceByteplusVkeClusterCreate(d *schema.ResourceData, meta interface{}) (err error) {
	clusterService := NewVkeClusterService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Create(clusterService, d, ResourceByteplusVkeCluster())
	if err != nil {
		return fmt.Errorf("error on creating cluster  %q, %w", d.Id(), err)
	}
	return resourceByteplusVkeClusterRead(d, meta)
}

func resourceByteplusVkeClusterRead(d *schema.ResourceData, meta interface{}) (err error) {
	clusterService := NewVkeClusterService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(clusterService, d, ResourceByteplusVkeCluster())
	if err != nil {
...
func resourceByteplusVkeClusterUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	clusterService := NewVkeClusterService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Update(clusterService, d, ResourceByteplusVkeCluster())
	if err != nil {
...
func resourceByteplusVkeClusterDelete(d *schema.ResourceData, meta interface{}) (err error) {
	clusterService := NewVkeClusterService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(clusterService, d, ResourceByteplusVkeCluster())
	if err != nil {
