...
func DataSourceByteplusVkeVkeClusters() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusVkeClustersRead,
...
func dataSourceByteplusVkeClustersRead(d *schema.ResourceData, meta interface{}) error {
	clusterService := NewVkeClusterService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(clusterService, d, DataSourceByteplusVkeVkeClusters())
}
