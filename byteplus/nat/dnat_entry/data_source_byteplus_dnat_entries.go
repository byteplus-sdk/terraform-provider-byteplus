...
func DataSourceByteplusDnatEntries() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusDnatEntriesRead,
...
func dataSourceByteplusDnatEntriesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewDnatEntryService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusDnatEntries())
}
