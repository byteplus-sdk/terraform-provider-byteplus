...
const testAccByteplusDnatEntriesDatasourceConfig = `
...
func TestAccByteplusDnatEntriesDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_dnat_entries.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusDnatEntriesDatasourceConfig,
