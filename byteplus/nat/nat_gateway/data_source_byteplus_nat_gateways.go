...
func DataSourceByteplusNatGateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusNatGatewaysRead,
...
func dataSourceByteplusNatGatewaysRead(d *schema.ResourceData, meta interface{}) error {
	natGatewayService := NewNatGatewayService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(natGatewayService, d, DataSourceByteplusNatGateways())
}
