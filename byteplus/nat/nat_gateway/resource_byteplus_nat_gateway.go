...
func ResourceByteplusNatGateway() *schema.Resource {
	return &schema.Resource{
		Create: resourceByteplusNatGatewayCreate,
		Read:   resourceByteplusNatGatewayRead,
		Update: resourceByteplusNatGatewayUpdate,
		Delete: resourceByteplusNatGatewayDelete,
...
func resourceByteplusNatGatewayCreate(d *schema.ResourceData, meta interface{}) (err error) {
	natGatewayService := NewNatGatewayService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Create(natGatewayService, d, ResourceByteplusNatGateway())
	if err != nil {
		return fmt.Errorf("error on creating nat gateway  %q, %w", d.Id(), err)
	}
	return resourceByteplusNatGatewayRead(d, meta)
}

func resourceByteplusNatGatewayRead(d *schema.ResourceData, meta interface{}) (err error) {
	natGatewayService := NewNatGatewayService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(natGatewayService, d, ResourceByteplusNatGateway())
	if err != nil {
...
func resourceByteplusNatGatewayUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	natGatewayService := NewNatGatewayService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Update(natGatewayService, d, ResourceByteplusNatGateway())
	if err != nil {
...
func resourceByteplusNatGatewayDelete(d *schema.ResourceData, meta interface{}) (err error) {
	natGatewayService := NewNatGatewayService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(natGatewayService, d, ResourceByteplusNatGateway())
	if err != nil {
