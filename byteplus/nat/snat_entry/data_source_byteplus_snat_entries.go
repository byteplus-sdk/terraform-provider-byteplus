...
func DataSourceByteplusSnatEntries() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusSnatEntriesRead,
...
func dataSourceByteplusSnatEntriesRead(d *schema.ResourceData, meta interface{}) error {
	snatEntryService := NewSnatEntryService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(snatEntryService, d, DataSourceByteplusSnatEntries())
}
