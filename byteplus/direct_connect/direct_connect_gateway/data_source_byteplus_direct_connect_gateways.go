...
func DataSourceByteplusDirectConnectGateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusDirectConnectGatewaysRead,
...
func dataSourceByteplusDirectConnectGatewaysRead(d *schema.ResourceData, meta interface{}) error {
	service := NewDirectConnectGatewayService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusDirectConnectGateways())
}
