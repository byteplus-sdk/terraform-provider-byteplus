...
func DataSourceByteplusDirectConnectBgpPeers() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusDirectConnectBgpPeersRead,
...
func dataSourceByteplusDirectConnectBgpPeersRead(d *schema.ResourceData, meta interface{}) error {
	service := NewDirectConnectBgpPeerService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusDirectConnectBgpPeers())
}
