...
func DataSourceByteplusDirectConnectConnections() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusDirectConnectConnectionsRead,
...
func dataSourceByteplusDirectConnectConnectionsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewDirectConnectConnectionService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusDirectConnectConnections())
}
