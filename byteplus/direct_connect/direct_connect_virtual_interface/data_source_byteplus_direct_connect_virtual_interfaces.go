...
func DataSourceByteplusDirectConnectVirtualInterfaces() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusDirectConnectVirtualInterfacesRead,
...
func dataSourceByteplusDirectConnectVirtualInterfacesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewDirectConnectVirtualInterfaceService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusDirectConnectVirtualInterfaces())
}
