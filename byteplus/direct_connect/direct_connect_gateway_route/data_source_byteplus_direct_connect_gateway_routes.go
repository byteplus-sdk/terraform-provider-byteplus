...
func DataSourceByteplusDirectConnectGatewayRoutes() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusDirectConnectGatewayRoutesRead,
...
func dataSourceByteplusDirectConnectGatewayRoutesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewDirectConnectGatewayRouteService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusDirectConnectGatewayRoutes())
}
