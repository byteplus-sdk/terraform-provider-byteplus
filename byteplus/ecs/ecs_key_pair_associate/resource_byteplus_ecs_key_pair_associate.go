...
func ResourceByteplusEcsKeyPairAssociate() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusEcsKeyPairAssociateCreate,
		Read:   resourceByteplusEcsKeyPairAssociateRead,
		Delete: resourceByteplusEcsKeyPairAssociateDelete,
...
func resourceByteplusEcsKeyPairAssociateCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewEcsKeyPairAssociateService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Create(service, d, ResourceByteplusEcsKeyPairAssociate())
	if err != nil {
		return fmt.Errorf("error on creating ecs key pair Associate %q, %s", d.Id(), err)
	}
	return resourceByteplusEcsKeyPairAssociateRead(d, meta)
}

func resourceByteplusEcsKeyPairAssociateRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewEcsKeyPairAssociateService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(service, d, ResourceByteplusEcsKeyPairAssociate())
	if err != nil {
...
func resourceByteplusEcsKeyPairAssociateDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewEcsKeyPairAssociateService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(service, d, ResourceByteplusEcsKeyPairAssociate())
	if err != nil {
