...
func DataSourceByteplusEcsInstanceTypes() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusEcsInstanceTypesRead,
...
func dataSourceByteplusEcsInstanceTypesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewEcsInstanceTypeService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusEcsInstanceTypes())
}
