...
func DataSourceByteplusEcsKeyPairs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusEcsKeyPairsRead,
...
func dataSourceByteplusEcsKeyPairsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewEcsKeyPairService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusEcsKeyPairs())
}
