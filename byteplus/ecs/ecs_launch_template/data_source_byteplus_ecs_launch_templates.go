...
func DataSourceByteplusEcsLaunchTemplates() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusEcsLaunchTemplatesRead,
...
func dataSourceByteplusEcsLaunchTemplatesRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewEcsLaunchTemplateService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusEcsLaunchTemplates())
}
