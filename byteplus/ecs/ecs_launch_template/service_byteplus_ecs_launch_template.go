...
type ByteplusEcsLaunchTemplateService struct {
	Client     *bp.SdkClient
	Dispatcher *bp.Dispatcher
}

func (s *ByteplusEcsLaunchTemplateService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *ByteplusEcsLaunchTemplateService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *ByteplusEcsLaunchTemplateService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *ByteplusEcsLaunchTemplateService) RefreshResourceState(data *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
	return &resource.StateChangeConf{}
}

func (s *ByteplusEcsLaunchTemplateService) WithResourceResponseHandlers(m map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *ByteplusEcsLaunchTemplateService) CreateResource(data *schema.ResourceData, resource *schema.Resource) []bp.Callback {
...
func (s *ByteplusEcsLaunchTemplateService) ModifyResource(data *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	// 查询默认版本，避免错删默认版本
...
func (s *ByteplusEcsLaunchTemplateService) RemoveResource(data *schema.ResourceData, r *schema.Resource) []bp.Callback {
	callback := bp.Callback{
		Call: bp.SdkCall{
...
func (s *ByteplusEcsLaunchTemplateService) DatasourceResources(data *schema.ResourceData, resource *schema.Resource) bp.DataSourceInfo {
...
func (s *ByteplusEcsLaunchTemplateService) ReadResourceId(id string) string {
	return id
}

func NewEcsLaunchTemplateService(client *bp.SdkClient) *ByteplusEcsLaunchTemplateService {
	return &ByteplusEcsLaunchTemplateService{
		Client:     client,
		Dispatcher: &bp.Dispatcher{},
	}
}
...
func (s *ByteplusEcsLaunchTemplateService) getLaunchTemplateVersions(m map[string]interface{}) (data []interface{}, err error) {
	var (
		resp    *map[string]interface{}
		results interface{}
		ok      bool
