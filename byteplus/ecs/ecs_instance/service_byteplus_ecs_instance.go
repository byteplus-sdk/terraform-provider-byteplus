...
func (s *ByteplusEcsService) readInstanceTypes(sourceData []interface{}) (extraData []interface{}, err error) {
...
func (s *ByteplusEcsService) readEbsVolumes(sourceData []interface{}) (extraData []interface{}, err error) {
	//merge ebs
	var (
		wg      sync.WaitGroup
		syncMap sync.Map
