...
func DataSourceByteplusEcsInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusInstancesRead,
...
func dataSourceByteplusInstancesRead(d *schema.ResourceData, meta interface{}) error {
	ecsService := NewEcsService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(ecsService, d, DataSourceByteplusEcsInstances())
}
