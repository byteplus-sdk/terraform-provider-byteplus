...
func DataSourceByteplusEcsAvailableResources() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusEcsAvailableResourcesRead,
...
func dataSourceByteplusEcsAvailableResourcesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewEcsAvailableResourceService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusEcsAvailableResources())
}
