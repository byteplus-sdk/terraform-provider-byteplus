...
func DataSourceByteplusImages() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusImagesRead,
...
func dataSourceByteplusImagesRead(d *schema.ResourceData, meta interface{}) error {
	imageService := NewImageService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(imageService, d, DataSourceByteplusImages())
}
