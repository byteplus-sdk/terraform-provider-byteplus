...
func DataSourceByteplusKafkaAllowLists() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusKafkaAllowListsRead,
...
func dataSourceByteplusKafkaAllowListsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewKafkaAllowListService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusKafkaAllowLists())
}
