...
func DataSourceByteplusKafkaTopicPartitions() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusKafkaTopicPartitionsRead,
...
func dataSourceByteplusKafkaTopicPartitionsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewKafkaTopicPartitionService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusKafkaTopicPartitions())
}
