...
func DataSourceByteplusKafkaInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusKafkaInstancesRead,
...
func dataSourceByteplusKafkaInstancesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewKafkaInstanceService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusKafkaInstances())
}
