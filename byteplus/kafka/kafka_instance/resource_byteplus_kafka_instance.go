...
func ResourceByteplusKafkaInstance() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusKafkaInstanceCreate,
		Read:   resourceByteplusKafkaInstanceRead,
		Update: resourceByteplusKafkaInstanceUpdate,
		Delete: resourceByteplusKafkaInstanceDelete,
...
func resourceByteplusKafkaInstanceCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewKafkaInstanceService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusKafkaInstance())
	if err != nil {
		return fmt.Errorf("error on creating kafka_instance %q, %s", d.Id(), err)
	}
	return resourceByteplusKafkaInstanceRead(d, meta)
}

func resourceByteplusKafkaInstanceRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewKafkaInstanceService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusKafkaInstance())
	if err != nil {
...
func resourceByteplusKafkaInstanceUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewKafkaInstanceService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusKafkaInstance())
	if err != nil {
...
func resourceByteplusKafkaInstanceDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewKafkaInstanceService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusKafkaInstance())
	if err != nil {
