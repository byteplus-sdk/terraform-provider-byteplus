...
func DataSourceByteplusKafkaTopics() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusKafkaTopicsRead,
...
func dataSourceByteplusKafkaTopicsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewKafkaTopicService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusKafkaTopics())
}
