...
func DataSourceByteplusCrTags() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusCrTagsRead,
...
func dataSourceByteplusCrTagsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCrTagService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusCrTags())
}
