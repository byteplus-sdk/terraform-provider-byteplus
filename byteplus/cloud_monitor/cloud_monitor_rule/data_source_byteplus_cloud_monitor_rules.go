...
func DataSourceByteplusCloudMonitorRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusCloudMonitorRulesRead,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"enable": {
										Type:        schema.TypeBool,
										Computed:    true,
										Description: "Specifies whether to enable no-data alarm.",
									},
									"evaluation_count": {
										Type:        schema.TypeInt,
										Computed:    true,
										Description: "No data alarm triggering threshold.",
									},
								},
							},
						},
...
func dataSourceByteplusCloudMonitorRulesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCloudMonitorRuleService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusCloudMonitorRules())
}
