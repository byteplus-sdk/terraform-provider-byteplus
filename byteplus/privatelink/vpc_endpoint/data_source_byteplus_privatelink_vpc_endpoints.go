...
func DataSourceByteplusPrivatelinkVpcEndpoints() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusPrivatelinkVpcEndpointsRead,
...
func dataSourceByteplusPrivatelinkVpcEndpointsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewVpcEndpointService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusPrivatelinkVpcEndpoints())
}
