...
const testAccByteplusPrivatelinkVpcEndpointServicesDatasourceConfig = `
...
func TestAccByteplusPrivatelinkVpcEndpointServicesDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_privatelink_vpc_endpoint_services.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusPrivatelinkVpcEndpointServicesDatasourceConfig,
