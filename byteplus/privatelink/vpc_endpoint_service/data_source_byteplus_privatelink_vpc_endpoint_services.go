...
func DataSourceByteplusPrivatelinkVpcEndpointServices() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusPrivatelinkVpcEndpointServiceRead,
...
func dataSourceByteplusPrivatelinkVpcEndpointServiceRead(d *schema.ResourceData, meta interface{}) error {
	service := NewService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusPrivatelinkVpcEndpointServices())
}
