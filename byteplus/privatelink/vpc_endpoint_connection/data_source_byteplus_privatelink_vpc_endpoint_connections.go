...
func DataSourceByteplusPrivatelinkVpcEndpointConnections() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusPrivatelinkVpcEndpointConnectionsRead,
...
func dataSourceByteplusPrivatelinkVpcEndpointConnectionsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewVpcEndpointConnectionService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusPrivatelinkVpcEndpointConnections())
}
