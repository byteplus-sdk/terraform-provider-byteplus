...
const testAccByteplusPrivatelinkVpcEndpointConnectionsDatasourceConfig = `
...
func TestAccByteplusPrivatelinkVpcEndpointConnectionsDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_privatelink_vpc_endpoint_connections.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusPrivatelinkVpcEndpointConnectionsDatasourceConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(acc.ResourceId, "connections.#", "1"),
				),
			},
		},
	})
