...
const testAccByteplusPrivatelinkVpcEndpointServicePermissionsDatasourceConfig = `
...
func TestAccByteplusPrivatelinkVpcEndpointServicePermissionsDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_privatelink_vpc_endpoint_service_permissions.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusPrivatelinkVpcEndpointServicePermissionsDatasourceConfig,
