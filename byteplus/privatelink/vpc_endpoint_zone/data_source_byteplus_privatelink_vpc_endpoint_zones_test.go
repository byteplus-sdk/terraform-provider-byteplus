...
const testAccByteplusPrivatelinkVpcEndpointZonesDatasourceConfig = `
...
func TestAccByteplusPrivatelinkVpcEndpointZonesDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_privatelink_vpc_endpoint_zones.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusPrivatelinkVpcEndpointZonesDatasourceConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(acc.ResourceId, "vpc_endpoint_zones.#", "1"),
				),
			},
		},
	})
