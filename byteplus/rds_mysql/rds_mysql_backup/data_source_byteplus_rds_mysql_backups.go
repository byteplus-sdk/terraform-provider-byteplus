...
func DataSourceByteplusRdsMysqlBackups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRdsMysqlBackupsRead,
...
func dataSourceByteplusRdsMysqlBackupsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewRdsMysqlBackupService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusRdsMysqlBackups())
}
