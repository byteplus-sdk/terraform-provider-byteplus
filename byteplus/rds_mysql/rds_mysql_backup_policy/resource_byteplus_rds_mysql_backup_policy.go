...
func ResourceByteplusRdsMysqlBackupPolicy() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusRdsMysqlBackupPolicyCreate,
		Read:   resourceByteplusRdsMysqlBackupPolicyRead,
		Update: resourceByteplusRdsMysqlBackupPolicyUpdate,
		Delete: resourceByteplusRdsMysqlBackupPolicyDelete,
...
func resourceByteplusRdsMysqlBackupPolicyCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewRdsMysqlBackupPolicyService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusRdsMysqlBackupPolicy())
	if err != nil {
		return fmt.Errorf("error on creating rds_mysql_backup_policy %q, %s", d.Id(), err)
	}
	return resourceByteplusRdsMysqlBackupPolicyRead(d, meta)
}

func resourceByteplusRdsMysqlBackupPolicyRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewRdsMysqlBackupPolicyService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusRdsMysqlBackupPolicy())
	if err != nil {
...
func resourceByteplusRdsMysqlBackupPolicyUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewRdsMysqlBackupPolicyService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusRdsMysqlBackupPolicy())
	if err != nil {
...
func resourceByteplusRdsMysqlBackupPolicyDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewRdsMysqlBackupPolicyService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusRdsMysqlBackupPolicy())
	if err != nil {
