...
func DataSourceByteplusRdsMysqlInstanceSpecs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRdsMysqlInstanceSpecsRead,
...
func dataSourceByteplusRdsMysqlInstanceSpecsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewRdsMysqlInstanceSpecService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusRdsMysqlInstanceSpecs())
}
