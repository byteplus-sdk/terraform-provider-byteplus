...
func DataSourceByteplusRdsMysqlParameterTemplates() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRdsMysqlParameterTemplatesRead,
...
func dataSourceByteplusRdsMysqlParameterTemplatesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewRdsMysqlParameterTemplateService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusRdsMysqlParameterTemplates())
}
