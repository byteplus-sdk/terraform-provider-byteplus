...
func DataSourceByteplusRdsMysqlInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRdsMysqlInstancesRead,
...
func dataSourceByteplusRdsMysqlInstancesRead(d *schema.ResourceData, meta interface{}) error {
	rdsMysqlInstanceService := NewRdsMysqlInstanceService(meta.(*bp.SdkClient))
	return rdsMysqlInstanceService.Dispatcher.Data(rdsMysqlInstanceService, d, DataSourceByteplusRdsMysqlInstances())
}
