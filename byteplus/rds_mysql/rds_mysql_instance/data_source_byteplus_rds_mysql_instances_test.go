...
const testAccByteplusRdsMysqlInstancesDatasourceConfig = `
...
data "byteplus_rds_mysql_instances" "foo"{
    instance_id = byteplus_rds_mysql_instance.foo.id
}
`

func TestAccByteplusRdsMysqlInstancesDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_rds_mysql_instances.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusRdsMysqlInstancesDatasourceConfig,
