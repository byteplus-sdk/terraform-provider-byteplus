...
const testAccByteplusRdsMysqlInstanceReadonlyNodeCreateConfig = `
...
const testAccByteplusRdsMysqlInstanceReadonlyNodeUpdateConfig = `
data "byteplus_zones" "foo"{
}
...
func TestAccByteplusRdsMysqlInstanceReadonlyNodeResource_Basic(t *testing.T) {
	resourceName := "byteplus_rds_mysql_instance_readonly_node.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusRdsMysqlInstanceReadonlyNodeCreateConfig,
...
func TestAccByteplusRdsMysqlInstanceReadonlyNodeResource_Update(t *testing.T) {
	resourceName := "byteplus_rds_mysql_instance_readonly_node.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccByteplusRdsMysqlInstanceReadonlyNodeUpdateConfig,
				Check: resource.ComposeTestCheckFunc(
					byteplus.AccTestCheckResourceExists(acc),
