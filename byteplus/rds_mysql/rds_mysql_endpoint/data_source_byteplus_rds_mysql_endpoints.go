...
func DataSourceByteplusRdsMysqlEndpoints() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRdsMysqlEndpointsRead,
...
func dataSourceByteplusRdsMysqlEndpointsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewRdsMysqlEndpointService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusRdsMysqlEndpoints())
}
