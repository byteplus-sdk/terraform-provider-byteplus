...
func DataSourceByteplusRdsMysqlAllowLists() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRdsMysqlAllowListsRead,
...
func dataSourceByteplusRdsMysqlAllowListsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewRdsMysqlAllowListService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusRdsMysqlAllowLists())
}
