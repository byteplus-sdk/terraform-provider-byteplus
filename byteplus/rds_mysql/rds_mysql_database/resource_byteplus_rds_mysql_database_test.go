...
const testAccByteplusRdsMysqlDatabaseCreateConfig = `
...
func TestAccByteplusRdsMysqlDatabaseResource_Basic(t *testing.T) {
	resourceName := "byteplus_rds_mysql_database.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusRdsMysqlDatabaseCreateConfig,
