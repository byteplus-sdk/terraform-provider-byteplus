...
func DataSourceByteplusVpnGatewayRoutes() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusVpnGatewayRoutesRead,
...
func dataSourceByteplusVpnGatewayRoutesRead(d *schema.ResourceData, meta interface{}) error {
	routeService := NewVpnGatewayRouteService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(routeService, d, DataSourceByteplusVpnGatewayRoutes())
}
