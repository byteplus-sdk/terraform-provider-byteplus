...
const testAccByteplusVpnGatewayRouteCreateConfig = `
...
const testAccByteplusVpnGatewayRouteUpdateConfig = `
data "byteplus_zones" "foo"{
}
...
func TestAccByteplusVpnGatewayRouteResource_Basic(t *testing.T) {
	resourceName := "byteplus_vpn_gateway_route.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusVpnGatewayRouteCreateConfig,
...
func TestAccByteplusVpnGatewayRouteResource_Update(t *testing.T) {
	resourceName := "byteplus_vpn_gateway_route.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:             testAccByteplusVpnGatewayRouteUpdateConfig,
				PlanOnly:           true,
