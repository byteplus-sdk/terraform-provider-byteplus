...
func DataSourceByteplusVpnConnections() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusVpnConnectionsRead,
...
func dataSourceByteplusVpnConnectionsRead(d *schema.ResourceData, meta interface{}) error {
	vpnConnectionService := NewVpnConnectionService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(vpnConnectionService, d, DataSourceByteplusVpnConnections())
}
