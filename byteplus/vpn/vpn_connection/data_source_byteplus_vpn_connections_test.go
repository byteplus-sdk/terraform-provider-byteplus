...
const testAccByteplusVpnConnectionsDatasourceConfig = `
...
func TestAccByteplusVpnConnectionsDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_vpn_connections.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusVpnConnectionsDatasourceConfig,
