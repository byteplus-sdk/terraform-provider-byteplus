...
func DataSourceByteplusCustomerGateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusCustomerGatewaysRead,
...
func dataSourceByteplusCustomerGatewaysRead(d *schema.ResourceData, meta interface{}) error {
	customerGatewayService := NewCustomerGatewayService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(customerGatewayService, d, DataSourceByteplusCustomerGateways())
}
