...
func DataSourceByteplusSslVpnClientCerts() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusSslVpnClientCertsRead,
...
func dataSourceByteplusSslVpnClientCertsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewSslVpnClientCertService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusSslVpnClientCerts())
}
