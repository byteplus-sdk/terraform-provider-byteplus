...
func DataSourceByteplusVpnGateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusVpnGatewaysRead,
...
func dataSourceByteplusVpnGatewaysRead(d *schema.ResourceData, meta interface{}) error {
	vpnGatewayService := NewVpnGatewayService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(vpnGatewayService, d, DataSourceByteplusVpnGateways())
}
