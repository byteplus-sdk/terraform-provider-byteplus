...
func DataSourceByteplusSslVpnServers() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusSslVpnServersRead,
...
func dataSourceByteplusSslVpnServersRead(d *schema.ResourceData, meta interface{}) error {
	service := NewSslVpnServerService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusSslVpnServers())
}
