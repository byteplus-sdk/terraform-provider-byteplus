...
func DataSourceByteplusVpcs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusVpcsRead,
...
func dataSourceByteplusVpcsRead(d *schema.ResourceData, meta interface{}) error {
	vpcService := NewVpcService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(vpcService, d, DataSourceByteplusVpcs())
}
