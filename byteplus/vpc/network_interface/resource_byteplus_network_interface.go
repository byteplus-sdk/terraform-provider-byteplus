...
func ResourceByteplusNetworkInterface() *schema.Resource {
	return &schema.Resource{
		Delete: resourceByteplusNetworkInterfaceDelete,
		Create: resourceByteplusNetworkInterfaceCreate,
		Read:   resourceByteplusNetworkInterfaceRead,
		Update: resourceByteplusNetworkInterfaceUpdate,
...
func resourceByteplusNetworkInterfaceCreate(d *schema.ResourceData, meta interface{}) error {
	networkInterfaceService := NewNetworkInterfaceService(meta.(*bp.SdkClient))
	if err := bp.DefaultDispatcher().Create(networkInterfaceService, d, ResourceByteplusNetworkInterface()); err != nil {
		return fmt.Errorf("error on creating network interface  %q, %w", d.Id(), err)
	}
	return resourceByteplusNetworkInterfaceRead(d, meta)
}

func resourceByteplusNetworkInterfaceRead(d *schema.ResourceData, meta interface{}) error {
	networkInterfaceService := NewNetworkInterfaceService(meta.(*bp.SdkClient))
	if err := bp.DefaultDispatcher().Read(networkInterfaceService, d, ResourceByteplusNetworkInterface()); err != nil {
		return fmt.Errorf("error on reading network interface %q, %w", d.Id(), err)
	}
	return nil
}

func resourceByteplusNetworkInterfaceUpdate(d *schema.ResourceData, meta interface{}) error {
	networkInterfaceService := NewNetworkInterfaceService(meta.(*bp.SdkClient))
	if err := bp.DefaultDispatcher().Update(networkInterfaceService, d, ResourceByteplusNetworkInterface()); err != nil {
		return fmt.Errorf("error on updating network interface %q, %w", d.Id(), err)
	}
	return resourceByteplusNetworkInterfaceRead(d, meta)
}

func resourceByteplusNetworkInterfaceDelete(d *schema.ResourceData, meta interface{}) error {
	networkInterfaceService := NewNetworkInterfaceService(meta.(*bp.SdkClient))
	if err := bp.DefaultDispatcher().Delete(networkInterfaceService, d, ResourceByteplusNetworkInterface()); err != nil {
