...
func DataSourceByteplusNetworkInterfaces() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusNetworkInterfacesRead,
...
func dataSourceByteplusNetworkInterfacesRead(d *schema.ResourceData, meta interface{}) error {
	networkInterfaceService := NewNetworkInterfaceService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(networkInterfaceService, d, DataSourceByteplusNetworkInterfaces())
}
