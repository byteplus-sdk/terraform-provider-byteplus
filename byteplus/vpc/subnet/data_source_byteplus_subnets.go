...
func DataSourceByteplusSubnets() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusSubnetsRead,
...
func dataSourceByteplusSubnetsRead(d *schema.ResourceData, meta interface{}) error {
	subnetService := NewSubnetService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(subnetService, d, DataSourceByteplusSubnets())
}
