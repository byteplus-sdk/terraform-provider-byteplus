...
type ByteplusRouteTableAssociateService struct {
	Client *bp.SdkClient
}

func NewRouteTableAssociateService(c *bp.SdkClient) *ByteplusRouteTableAssociateService {
	return &ByteplusRouteTableAssociateService{
		Client: c,
	}
}

func (s *ByteplusRouteTableAssociateService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *ByteplusRouteTableAssociateService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *ByteplusRouteTableAssociateService) ReadResource(resourceData *schema.ResourceData, associateId string) (data map[string]interface{}, err error) {
	var (
		results        []interface{}
		ok             bool
		associate      bool
...
func (s *ByteplusRouteTableAssociateService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (ByteplusRouteTableAssociateService) WithResourceResponseHandlers(routeTables map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *ByteplusRouteTableAssociateService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	var vpcId string
...
func (s *ByteplusRouteTableAssociateService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	return nil
}

func (s *ByteplusRouteTableAssociateService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []bp.Callback {
	var vpcId string
...
func (s *ByteplusRouteTableAssociateService) DatasourceResources(*schema.ResourceData, *schema.Resource) bp.DataSourceInfo {
	return bp.DataSourceInfo{}
}

func (s *ByteplusRouteTableAssociateService) ReadResourceId(id string) string {
	return id
}
