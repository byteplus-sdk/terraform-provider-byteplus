...
func DataSourceByteplusRouteEntries() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRouteEntriesRead,
...
func dataSourceByteplusRouteEntriesRead(d *schema.ResourceData, meta interface{}) error {
	routeEntryService := NewRouteEntryService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(routeEntryService, d, DataSourceByteplusRouteEntries())
}
