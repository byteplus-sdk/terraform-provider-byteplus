...
type ByteplusIpv6AddressService struct {
	Client     *bp.SdkClient
	Dispatcher *bp.Dispatcher
}

func NewIpv6AddressService(c *bp.SdkClient) *ByteplusIpv6AddressService {
	return &ByteplusIpv6AddressService{
		Client:     c,
		Dispatcher: &bp.Dispatcher{},
	}
}

func (s *ByteplusIpv6AddressService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *ByteplusIpv6AddressService) ReadResources(condition map[string]interface{}) (ipv6Addresses []interface{}, err error) {
	var (
...
func (s *ByteplusIpv6AddressService) ReadResource(resourceData *schema.ResourceData, allocationId string) (data map[string]interface{}, err error) {
	return data, err
}

func (s *ByteplusIpv6AddressService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
	return nil
}

func (ByteplusIpv6AddressService) WithResourceResponseHandlers(ipv6Address map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *ByteplusIpv6AddressService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	return nil
}

func (s *ByteplusIpv6AddressService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	return nil
}

func (s *ByteplusIpv6AddressService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []bp.Callback {
	return nil
}

func (s *ByteplusIpv6AddressService) DatasourceResources(*schema.ResourceData, *schema.Resource) bp.DataSourceInfo {
...
func (s *ByteplusIpv6AddressService) ReadResourceId(id string) string {
	return id
}
