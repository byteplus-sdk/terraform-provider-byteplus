...
func DataSourceByteplusIpv6AddressBandwidths() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusIpv6AddressBandwidthsRead,
...
func dataSourceByteplusIpv6AddressBandwidthsRead(d *schema.ResourceData, meta interface{}) error {
	ipv6AddressBandwidthService := NewIpv6AddressBandwidthService(meta.(*bp.SdkClient))
	return ipv6AddressBandwidthService.Dispatcher.Data(ipv6AddressBandwidthService, d, DataSourceByteplusIpv6AddressBandwidths())
}
