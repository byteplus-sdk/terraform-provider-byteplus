...
func DataSourceByteplusIpv6Gateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusIpv6GatewaysRead,
...
func dataSourceByteplusIpv6GatewaysRead(d *schema.ResourceData, meta interface{}) error {
	ipv6GatewayService := NewIpv6GatewayService(meta.(*bp.SdkClient))
	return ipv6GatewayService.Dispatcher.Data(ipv6GatewayService, d, DataSourceByteplusIpv6Gateways())
}
