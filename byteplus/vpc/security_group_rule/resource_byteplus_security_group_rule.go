...
func ResourceByteplusSecurityGroupRule() *schema.Resource {
	return &schema.Resource{
		Create: resourceByteplusSecurityGroupRuleCreate,
		Read:   resourceByteplusSecurityGroupRuleRead,
		Update: resourceByteplusSecurityGroupRuleUpdate,
		Delete: resourceByteplusSecurityGroupRuleDelete,
...
func resourceByteplusSecurityGroupRuleCreate(d *schema.ResourceData, meta interface{}) (err error) {
	securityGroupRuleService := NewSecurityGroupRuleService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Create(securityGroupRuleService, d, ResourceByteplusSecurityGroupRule())
	if err != nil {
		return fmt.Errorf("error on creating securityGroupRuleService  %q, %w", d.Id(), err)
	}
	return resourceByteplusSecurityGroupRuleRead(d, meta)
}

func resourceByteplusSecurityGroupRuleRead(d *schema.ResourceData, meta interface{}) (err error) {
	securityGroupRuleService := NewSecurityGroupRuleService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(securityGroupRuleService, d, ResourceByteplusSecurityGroupRule())
	if err != nil {
...
func resourceByteplusSecurityGroupRuleUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	securityGroupRuleService := NewSecurityGroupRuleService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Update(securityGroupRuleService, d, ResourceByteplusSecurityGroupRule())
	if err != nil {
...
func resourceByteplusSecurityGroupRuleDelete(d *schema.ResourceData, meta interface{}) (err error) {
	securityGroupRuleService := NewSecurityGroupRuleService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(securityGroupRuleService, d, ResourceByteplusSecurityGroupRule())
	if err != nil {
