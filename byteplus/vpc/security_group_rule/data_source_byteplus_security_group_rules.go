...
func DataSourceByteplusSecurityGroupRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusSecurityGroupRulesRead,
...
func dataSourceByteplusSecurityGroupRulesRead(d *schema.ResourceData, meta interface{}) error {
	securityGroupService := NewSecurityGroupRuleService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(securityGroupService, d, DataSourceByteplusSecurityGroupRules())
}
