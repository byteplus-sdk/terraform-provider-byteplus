...
type ByteplusNetworkAclService struct {
	Client *bp.SdkClient
}

func NewNetworkAclService(c *bp.SdkClient) *ByteplusNetworkAclService {
	return &ByteplusNetworkAclService{
		Client: c,
	}
}

func (s *ByteplusNetworkAclService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *ByteplusNetworkAclService) ReadResources(condition map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *ByteplusNetworkAclService) ReadResource(resourceData *schema.ResourceData, networkAclId string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *ByteplusNetworkAclService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (ByteplusNetworkAclService) WithResourceResponseHandlers(acl map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *ByteplusNetworkAclService) CreateResource(resourceData *schema.ResourceData, r *schema.Resource) []bp.Callback {
...
func (s *ByteplusNetworkAclService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	var callbacks []bp.Callback
...
func (s *ByteplusNetworkAclService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []bp.Callback {
	var callbacks []bp.Callback
...
func (s *ByteplusNetworkAclService) DatasourceResources(*schema.ResourceData, *schema.Resource) bp.DataSourceInfo {
...
func (s *ByteplusNetworkAclService) ReadResourceId(id string) string {
	return id
}
...
func (s *ByteplusNetworkAclService) ProjectTrn() *bp.ProjectTrn {
