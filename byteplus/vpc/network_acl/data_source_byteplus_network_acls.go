...
func DataSourceByteplusNetworkAcls() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusNetworkAclsRead,
...
func dataSourceByteplusNetworkAclsRead(d *schema.ResourceData, meta interface{}) error {
	aclService := NewNetworkAclService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(aclService, d, DataSourceByteplusNetworkAcls())
}
