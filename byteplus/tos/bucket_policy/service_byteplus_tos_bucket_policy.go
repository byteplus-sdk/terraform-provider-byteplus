...
type ByteplusTosBucketPolicyService struct {
	Client *bp.SdkClient
}

func NewTosBucketPolicyService(c *bp.SdkClient) *ByteplusTosBucketPolicyService {
	return &ByteplusTosBucketPolicyService{
		Client: c,
	}
}

func (s *ByteplusTosBucketPolicyService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *ByteplusTosBucketPolicyService) ReadResources(condition map[string]interface{}) (data []interface{}, err error) {
...
func (s *ByteplusTosBucketPolicyService) ReadResource(resourceData *schema.ResourceData, instanceId string) (data map[string]interface{}, err error) {
...
func (s *ByteplusTosBucketPolicyService) RefreshResourceState(data *schema.ResourceData, strings []string, duration time.Duration, id string) *resource.StateChangeConf {
	return nil
}

func (s *ByteplusTosBucketPolicyService) WithResourceResponseHandlers(m map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *ByteplusTosBucketPolicyService) putBucketPolicy(data *schema.ResourceData, resource *schema.Resource, isUpdate bool) bp.Callback {
	return bp.Callback{
		Call: bp.SdkCall{
...
func (s *ByteplusTosBucketPolicyService) CreateResource(data *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	return []bp.Callback{s.putBucketPolicy(data, resource, false)}
}

func (s *ByteplusTosBucketPolicyService) ModifyResource(data *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	return []bp.Callback{s.putBucketPolicy(data, resource, true)}
}

func (s *ByteplusTosBucketPolicyService) RemoveResource(data *schema.ResourceData, r *schema.Resource) []bp.Callback {
...
func (s *ByteplusTosBucketPolicyService) DatasourceResources(data *schema.ResourceData, resource *schema.Resource) bp.DataSourceInfo {
	return bp.DataSourceInfo{}
}

func (s *ByteplusTosBucketPolicyService) ReadResourceId(id string) string {
	return id
}
