...
type ByteplusTosObjectService struct {
	Client *bp.SdkClient
}

func NewTosObjectService(c *bp.SdkClient) *ByteplusTosObjectService {
	return &ByteplusTosObjectService{
		Client: c,
	}
}

func (s *ByteplusTosObjectService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *ByteplusTosObjectService) ReadResources(condition map[string]interface{}) (data []interface{}, err error) {
...
func (s *ByteplusTosObjectService) ReadResource(resourceData *schema.ResourceData, instanceId string) (data map[string]interface{}, err error) {
	tos := s.Client.BypassSvcClient
...
func (s *ByteplusTosObjectService) RefreshResourceState(data *schema.ResourceData, target []string, timeout time.Duration, instanceId string) *resource.StateChangeConf {
...
func (ByteplusTosObjectService) WithResourceResponseHandlers(m map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *ByteplusTosObjectService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
...
func (s *ByteplusTosObjectService) ModifyResource(data *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	var callbacks []bp.Callback
...
func (s *ByteplusTosObjectService) setResourceTags(resourceData *schema.ResourceData, callbacks []bp.Callback) []bp.Callback {
	if _, ok := resourceData.GetOk("tags"); ok {
...
func (s *ByteplusTosObjectService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []bp.Callback {
...
func (s *ByteplusTosObjectService) DatasourceResources(data *schema.ResourceData, resource *schema.Resource) bp.DataSourceInfo {
...
func (s *ByteplusTosObjectService) ReadResourceId(id string) string {
	return id[strings.Index(id, ":")+1:]
}

func (s *ByteplusTosObjectService) beforePutObjectAcl() bp.BeforeCallFunc {
...
func (s *ByteplusTosObjectService) executePutObjectAcl() bp.ExecuteCallFunc {
...
func (s *ByteplusTosObjectService) createOrUpdateObjectAcl(resourceData *schema.ResourceData, resource *schema.Resource, isUpdate bool) bp.Callback {
	callback := bp.Callback{
		Call: bp.SdkCall{
			ServiceCategory: bp.ServiceBypass,
			Action:          "PutObjectAcl",
...
func (s *ByteplusTosObjectService) createOrReplaceObject(resourceData *schema.ResourceData, resource *schema.Resource, isUpdate bool) bp.Callback {
...
func (s *ByteplusTosObjectService) beforePutObjectTagging() bp.BeforeCallFunc {
	return func(d *schema.ResourceData, client *bp.SdkClient, call bp.SdkCall) (bool, error) {
...
func (s *ByteplusTosObjectService) executePutObjectTagging() bp.ExecuteCallFunc {
	return func(d *schema.ResourceData, client *bp.SdkClient, call bp.SdkCall) (*map[string]interface{}, error) {
		logger.Debug(logger.RespFormat, call.Action, call.SdkParam)
		//PutObjectTagging
