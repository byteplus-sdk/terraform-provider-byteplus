...
func ResourceByteplusTosObject() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusTosObjectCreate,
		Read:   resourceByteplusTosObjectRead,
		Update: resourceByteplusTosObjectUpdate,
		Delete: resourceByteplusTosObjectDelete,
...
func resourceByteplusTosObjectCreate(d *schema.ResourceData, meta interface{}) (err error) {
	tosBucketService := NewTosObjectService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Create(tosBucketService, d, ResourceByteplusTosObject())
	if err != nil {
		return fmt.Errorf("error on creating tos object %q, %s", d.Id(), err)
	}
	return resourceByteplusTosObjectRead(d, meta)
}

func resourceByteplusTosObjectRead(d *schema.ResourceData, meta interface{}) (err error) {
	tosBucketService := NewTosObjectService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(tosBucketService, d, ResourceByteplusTosObject())
	if err != nil {
...
func resourceByteplusTosObjectUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	tosBucketService := NewTosObjectService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Update(tosBucketService, d, ResourceByteplusTosObject())
	if err != nil {
...
func resourceByteplusTosObjectDelete(d *schema.ResourceData, meta interface{}) (err error) {
	tosBucketService := NewTosObjectService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(tosBucketService, d, ResourceByteplusTosObject())
	if err != nil {
