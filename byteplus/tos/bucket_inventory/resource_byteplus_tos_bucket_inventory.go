...
func ResourceByteplusTosBucketInventory() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusTosBucketInventoryCreate,
		Read:   resourceByteplusTosBucketInventoryRead,
		Update: resourceByteplusTosBucketInventoryUpdate,
		Delete: resourceByteplusTosBucketInventoryDelete,
...
func resourceByteplusTosBucketInventoryCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketInventoryService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusTosBucketInventory())
	if err != nil {
		return fmt.Errorf("error on creating tos_bucket_inventory %q, %s", d.Id(), err)
	}
	return resourceByteplusTosBucketInventoryRead(d, meta)
}

func resourceByteplusTosBucketInventoryRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketInventoryService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusTosBucketInventory())
	if err != nil {
...
func resourceByteplusTosBucketInventoryUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketInventoryService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusTosBucketInventory())
	if err != nil {
...
func resourceByteplusTosBucketInventoryDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketInventoryService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusTosBucketInventory())
	if err != nil {
