...
func DataSourceByteplusTosBucketInventories() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusTosBucketInventoriesRead,
...
func dataSourceByteplusTosBucketInventoriesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewTosBucketInventoryService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusTosBucketInventories())
}
