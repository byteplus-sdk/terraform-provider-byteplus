...
func DataSourceByteplusTosBuckets() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusTosBucketsRead,
...
func dataSourceByteplusTosBucketsRead(d *schema.ResourceData, meta interface{}) error {
	tosBucketService := NewTosBucketService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(tosBucketService, d, DataSourceByteplusTosBuckets())
}
