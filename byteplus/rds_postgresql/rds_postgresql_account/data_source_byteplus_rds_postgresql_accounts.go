...
func DataSourceByteplusRdsPostgresqlAccounts() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRdsPostgresqlAccountsRead,
...
func dataSourceByteplusRdsPostgresqlAccountsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewRdsPostgresqlAccountService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusRdsPostgresqlAccounts())
}
