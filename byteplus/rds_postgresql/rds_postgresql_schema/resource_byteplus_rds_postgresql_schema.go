...
func ResourceByteplusRdsPostgresqlSchema() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusRdsPostgresqlSchemaCreate,
		Read:   resourceByteplusRdsPostgresqlSchemaRead,
		Update: resourceByteplusRdsPostgresqlSchemaUpdate,
		Delete: resourceByteplusRdsPostgresqlSchemaDelete,
...
func resourceByteplusRdsPostgresqlSchemaCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewRdsPostgresqlSchemaService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusRdsPostgresqlSchema())
	if err != nil {
		return fmt.Errorf("error on creating rds_postgresql_schema %q, %s", d.Id(), err)
	}
	return resourceByteplusRdsPostgresqlSchemaRead(d, meta)
}

func resourceByteplusRdsPostgresqlSchemaRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewRdsPostgresqlSchemaService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusRdsPostgresqlSchema())
	if err != nil {
...
func resourceByteplusRdsPostgresqlSchemaUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewRdsPostgresqlSchemaService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusRdsPostgresqlSchema())
	if err != nil {
...
func resourceByteplusRdsPostgresqlSchemaDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewRdsPostgresqlSchemaService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusRdsPostgresqlSchema())
	if err != nil {
