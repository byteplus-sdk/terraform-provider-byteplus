...
func DataSourceByteplusRdsPostgresqlInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusRdsPostgresqlInstancesRead,
...
func dataSourceByteplusRdsPostgresqlInstancesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewRdsPostgresqlInstanceService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusRdsPostgresqlInstances())
}
