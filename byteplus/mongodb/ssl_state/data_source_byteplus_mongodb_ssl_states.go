...
func DataSourceByteplusMongoDBSSLStates() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusMongoDBSSLStatesRead,
...
func dataSourceByteplusMongoDBSSLStatesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewMongoDBSSLStateService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusMongoDBSSLStates())
}
