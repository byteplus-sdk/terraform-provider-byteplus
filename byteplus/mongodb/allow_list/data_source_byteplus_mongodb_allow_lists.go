...
func DataSourceByteplusMongoDBAllowLists() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusMongoDBAllowListsRead,
...
func dataSourceByteplusMongoDBAllowListsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewMongoDBAllowListService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusMongoDBAllowLists())
}
