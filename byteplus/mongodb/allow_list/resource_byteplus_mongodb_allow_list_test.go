...
const testAccByteplusMongodbAllowListCreateConfig = `
...
const testAccByteplusMongodbAllowListUpdateConfig = `
resource "byteplus_mongodb_allow_list" "foo" {
...
func TestAccByteplusMongodbAllowListResource_Basic(t *testing.T) {
	resourceName := "byteplus_mongodb_allow_list.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusMongodbAllowListCreateConfig,
...
func TestAccByteplusMongodbAllowListResource_Update(t *testing.T) {
	resourceName := "byteplus_mongodb_allow_list.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccByteplusMongodbAllowListUpdateConfig,
				Check: resource.ComposeTestCheckFunc(
					byteplus.AccTestCheckResourceExists(acc),
