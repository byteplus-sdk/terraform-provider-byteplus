...
func DataSourceByteplusMongoDBEndpoints() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusMongoDBEndpointsRead,
...
func dataSourceByteplusMongoDBEndpointsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewMongoDBEndpointService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusMongoDBEndpoints())
}
