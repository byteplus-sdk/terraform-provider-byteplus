...
const testAccByteplusMongodbInstanceParametersDatasourceConfig = `
...
func TestAccByteplusMongodbInstanceParametersDatasource_Basic(t *testing.T) {
	resourceName := "data.byteplus_mongodb_instance_parameters.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusMongodbInstanceParametersDatasourceConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(acc.ResourceId, "instance_parameters.#", "1"),
				),
			},
		},
	})
