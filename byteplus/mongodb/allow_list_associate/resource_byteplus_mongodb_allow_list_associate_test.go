...
const testAccByteplusMongodbAllowListAssociateCreateConfig = `
...
func TestAccByteplusMongodbAllowListAssociateResource_Basic(t *testing.T) {
	resourceName := "byteplus_mongodb_allow_list_associate.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccByteplusMongodbAllowListAssociateCreateConfig,
