...
func DataSourceByteplusMongoDBSpecs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusSpecsRead,
...
func dataSourceByteplusSpecsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewSpecService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceByteplusMongoDBSpecs())
}
