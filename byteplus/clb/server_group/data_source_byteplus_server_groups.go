...
func DataSourceByteplusServerGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusServerGroupsRead,
...
func dataSourceByteplusServerGroupsRead(d *schema.ResourceData, meta interface{}) error {
	serverGroupService := NewServerGroupService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(serverGroupService, d, DataSourceByteplusServerGroups())
}
