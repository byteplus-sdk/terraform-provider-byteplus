...
func DataSourceByteplusListeners() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusListenersRead,
...
func dataSourceByteplusListenersRead(d *schema.ResourceData, meta interface{}) error {
	listenerService := NewListenerService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(listenerService, d, DataSourceByteplusListeners())
}
