...
func ResourceByteplusListener() *schema.Resource {
	return &schema.Resource{
		Create: resourceByteplusListenerCreate,
		Read:   resourceByteplusListenerRead,
		Update: resourceByteplusListenerUpdate,
		Delete: resourceByteplusListenerDelete,
...
func resourceByteplusListenerCreate(d *schema.ResourceData, meta interface{}) (err error) {
	listenerService := NewListenerService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Create(listenerService, d, ResourceByteplusListener())
	if err != nil {
		return fmt.Errorf("error on creating listener  %q, %w", d.Id(), err)
	}
	return resourceByteplusListenerRead(d, meta)
}

func resourceByteplusListenerRead(d *schema.ResourceData, meta interface{}) (err error) {
	listenerService := NewListenerService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(listenerService, d, ResourceByteplusListener())
	if err != nil {
...
func resourceByteplusListenerUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	listenerService := NewListenerService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Update(listenerService, d, ResourceByteplusListener())
	if err != nil {
...
func resourceByteplusListenerDelete(d *schema.ResourceData, meta interface{}) (err error) {
	listenerService := NewListenerService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(listenerService, d, ResourceByteplusListener())
	if err != nil {
