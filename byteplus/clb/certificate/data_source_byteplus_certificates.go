...
func DataSourceByteplusCertificates() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusCertificatesRead,
...
func dataSourceByteplusCertificatesRead(d *schema.ResourceData, meta interface{}) error {
	certificateService := NewCertificateService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(certificateService, d, DataSourceByteplusCertificates())
}
