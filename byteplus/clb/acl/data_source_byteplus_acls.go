...
func DataSourceByteplusAcls() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusAclsRead,
...
func dataSourceByteplusAclsRead(d *schema.ResourceData, meta interface{}) error {
	aclService := NewAclService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(aclService, d, DataSourceByteplusAcls())
}
