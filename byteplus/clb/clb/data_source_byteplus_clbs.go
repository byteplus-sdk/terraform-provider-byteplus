...
func DataSourceByteplusClbs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusClbsRead,
...
func dataSourceByteplusClbsRead(d *schema.ResourceData, meta interface{}) error {
	clbService := NewClbService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(clbService, d, DataSourceByteplusClbs())
}
