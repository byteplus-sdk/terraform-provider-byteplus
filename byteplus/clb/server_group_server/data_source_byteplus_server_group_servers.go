...
func DataSourceByteplusServerGroupServers() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusServerGroupServersRead,
...
func dataSourceByteplusServerGroupServersRead(d *schema.ResourceData, meta interface{}) error {
	serverGroupServerService := NewServerGroupServerService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(serverGroupServerService, d, DataSourceByteplusServerGroupServers())
}
