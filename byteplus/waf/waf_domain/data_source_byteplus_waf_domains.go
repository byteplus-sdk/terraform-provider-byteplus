...
func DataSourceByteplusWafDomains() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusWafDomainsRead,
...
func dataSourceByteplusWafDomainsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewWafDomainService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusWafDomains())
}
