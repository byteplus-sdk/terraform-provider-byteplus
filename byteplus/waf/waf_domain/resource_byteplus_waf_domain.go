...
func ResourceByteplusWafDomain() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusWafDomainCreate,
		Read:   resourceByteplusWafDomainRead,
		Update: resourceByteplusWafDomainUpdate,
		Delete: resourceByteplusWafDomainDelete,
...
func resourceByteplusWafDomainCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafDomainService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusWafDomain())
	if err != nil {
		return fmt.Errorf("error on creating waf_domain %q, %s", d.Id(), err)
	}
	return resourceByteplusWafDomainRead(d, meta)
}

func resourceByteplusWafDomainRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafDomainService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusWafDomain())
	if err != nil {
...
func resourceByteplusWafDomainUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafDomainService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusWafDomain())
	if err != nil {
...
func resourceByteplusWafDomainDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafDomainService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusWafDomain())
	if err != nil {
