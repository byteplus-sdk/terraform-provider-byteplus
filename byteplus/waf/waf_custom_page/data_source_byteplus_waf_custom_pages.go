...
func DataSourceByteplusWafCustomPages() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusWafCustomPagesRead,
...
func dataSourceByteplusWafCustomPagesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewWafCustomPageService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusWafCustomPages())
}
