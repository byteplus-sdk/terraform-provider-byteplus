...
func ResourceByteplusWafCustomPage() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusWafCustomPageCreate,
		Read:   resourceByteplusWafCustomPageRead,
		Update: resourceByteplusWafCustomPageUpdate,
		Delete: resourceByteplusWafCustomPageDelete,
...
func resourceByteplusWafCustomPageCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafCustomPageService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusWafCustomPage())
	if err != nil {
		return fmt.Errorf("error on creating waf_custom_page %q, %s", d.Id(), err)
	}
	return resourceByteplusWafCustomPageRead(d, meta)
}

func resourceByteplusWafCustomPageRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafCustomPageService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusWafCustomPage())
	if err != nil {
...
func resourceByteplusWafCustomPageUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafCustomPageService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusWafCustomPage())
	if err != nil {
...
func resourceByteplusWafCustomPageDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafCustomPageService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusWafCustomPage())
	if err != nil {
