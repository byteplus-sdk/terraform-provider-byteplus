...
func DataSourceByteplusWafIpGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusWafIpGroupsRead,
...
func dataSourceByteplusWafIpGroupsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewWafIpGroupService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusWafIpGroups())
}
