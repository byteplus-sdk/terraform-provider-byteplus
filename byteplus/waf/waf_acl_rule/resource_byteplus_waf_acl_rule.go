...
func ResourceByteplusWafAclRule() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusWafAclRuleCreate,
		Read:   resourceByteplusWafAclRuleRead,
		//Update: resourceByteplusWafAclRuleUpdate,
		Delete: resourceByteplusWafAclRuleDelete,
...
func resourceByteplusWafAclRuleCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafAclRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusWafAclRule())
	if err != nil {
		return fmt.Errorf("error on creating waf_acl_rule %q, %s", d.Id(), err)
	}
	return resourceByteplusWafAclRuleRead(d, meta)
}

func resourceByteplusWafAclRuleRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafAclRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusWafAclRule())
	if err != nil {
...
//func resourceByteplusWafAclRuleUpdate(d *schema.ResourceData, meta interface{}) (err error) {
//	service := NewWafAclRuleService(meta.(*bp.SdkClient))
//	err = service.Dispatcher.Update(service, d, ResourceByteplusWafAclRule())
//	if err != nil {
...
func resourceByteplusWafAclRuleDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafAclRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusWafAclRule())
	if err != nil {
