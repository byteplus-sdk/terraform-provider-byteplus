...
func DataSourceByteplusWafAclRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusWafAclRulesRead,
...
func dataSourceByteplusWafAclRulesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewWafAclRuleService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusWafAclRules())
}
