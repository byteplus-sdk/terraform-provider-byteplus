...
func ResourceByteplusWafCcRule() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusWafCcRuleCreate,
		Read:   resourceByteplusWafCcRuleRead,
		Update: resourceByteplusWafCcRuleUpdate,
		Delete: resourceByteplusWafCcRuleDelete,
...
func resourceByteplusWafCcRuleCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafCcRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusWafCcRule())
	if err != nil {
		return fmt.Errorf("error on creating waf_cc_rule %q, %s", d.Id(), err)
	}
	return resourceByteplusWafCcRuleRead(d, meta)
}

func resourceByteplusWafCcRuleRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafCcRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusWafCcRule())
	if err != nil {
...
func resourceByteplusWafCcRuleUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafCcRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusWafCcRule())
	if err != nil {
...
func resourceByteplusWafCcRuleDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafCcRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusWafCcRule())
	if err != nil {
