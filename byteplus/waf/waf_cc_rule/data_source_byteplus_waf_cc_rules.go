...
func DataSourceByteplusWafCcRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusWafCcRulesRead,
...
func dataSourceByteplusWafCcRulesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewWafCcRuleService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusWafCcRules())
}
