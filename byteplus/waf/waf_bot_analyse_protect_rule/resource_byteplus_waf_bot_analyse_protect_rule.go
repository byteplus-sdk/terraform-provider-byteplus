...
```
$ terraform import byteplus_waf_bot_analyse_protect_rule.default resource_id:bot_space:host
```

*/

func ResourceByteplusWafBotAnalyseProtectRule() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceByteplusWafBotAnalyseProtectRuleCreate,
		Read:   resourceByteplusWafBotAnalyseProtectRuleRead,
		Update: resourceByteplusWafBotAnalyseProtectRuleUpdate,
		Delete: resourceByteplusWafBotAnalyseProtectRuleDelete,
...
func resourceByteplusWafBotAnalyseProtectRuleCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafBotAnalyseProtectRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceByteplusWafBotAnalyseProtectRule())
	if err != nil {
		return fmt.Errorf("error on creating waf_bot_analyse_protect_rule %q, %s", d.Id(), err)
	}
	return resourceByteplusWafBotAnalyseProtectRuleRead(d, meta)
}

func resourceByteplusWafBotAnalyseProtectRuleRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafBotAnalyseProtectRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceByteplusWafBotAnalyseProtectRule())
	if err != nil {
...
func resourceByteplusWafBotAnalyseProtectRuleUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafBotAnalyseProtectRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceByteplusWafBotAnalyseProtectRule())
	if err != nil {
...
func resourceByteplusWafBotAnalyseProtectRuleDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewWafBotAnalyseProtectRuleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceByteplusWafBotAnalyseProtectRule())
	if err != nil {
