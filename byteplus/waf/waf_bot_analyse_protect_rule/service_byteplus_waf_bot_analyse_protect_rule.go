...
type ByteplusWafBotAnalyseProtectRuleService struct {
	Client     *bp.SdkClient
	Dispatcher *bp.Dispatcher
}

func NewWafBotAnalyseProtectRuleService(c *bp.SdkClient) *ByteplusWafBotAnalyseProtectRuleService {
	return &ByteplusWafBotAnalyseProtectRuleService{
		Client:     c,
		Dispatcher: &bp.Dispatcher{},
	}
}

func (s *ByteplusWafBotAnalyseProtectRuleService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *ByteplusWafBotAnalyseProtectRuleService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *ByteplusWafBotAnalyseProtectRuleService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
		ruleTag string
...
func (s *ByteplusWafBotAnalyseProtectRuleService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
	return &resource.StateChangeConf{}
}

func (s *ByteplusWafBotAnalyseProtectRuleService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
...
func (ByteplusWafBotAnalyseProtectRuleService) WithResourceResponseHandlers(d map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *ByteplusWafBotAnalyseProtectRuleService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	callback := bp.Callback{
		Call: bp.SdkCall{
...
func (s *ByteplusWafBotAnalyseProtectRuleService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []bp.Callback {
	callback := bp.Callback{
		Call: bp.SdkCall{
...
func (s *ByteplusWafBotAnalyseProtectRuleService) DatasourceResources(*schema.ResourceData, *schema.Resource) bp.DataSourceInfo {
	return bp.DataSourceInfo{
		CollectField: "data",
	}
}

func (s *ByteplusWafBotAnalyseProtectRuleService) ReadResourceId(id string) string {
	return id
}
