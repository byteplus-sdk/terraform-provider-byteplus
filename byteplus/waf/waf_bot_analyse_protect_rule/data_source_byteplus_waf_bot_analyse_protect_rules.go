...
func DataSourceByteplusWafBotAnalyseProtectRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusWafBotAnalyseProtectRulesRead,
...
func dataSourceByteplusWafBotAnalyseProtectRulesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewWafBotAnalyseProtectRuleService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusWafBotAnalyseProtectRules())
}
