...
func DataSourceByteplusWafHostGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusWafHostGroupsRead,
...
func dataSourceByteplusWafHostGroupsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewWafHostGroupService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusWafHostGroups())
}
