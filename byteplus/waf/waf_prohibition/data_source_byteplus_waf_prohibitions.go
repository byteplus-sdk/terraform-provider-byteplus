...
func DataSourceByteplusWafProhibitions() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusWafProhibitionsRead,
...
func dataSourceByteplusWafProhibitionsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewWafProhibitionService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusWafProhibitions())
}
