...
func DataSourceByteplusWafCustomBots() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusWafCustomBotsRead,
...
func dataSourceByteplusWafCustomBotsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewWafCustomBotService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusWafCustomBots())
}
