...
func DataSourceByteplusWafSystemBots() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceByteplusWafSystemBotsRead,
...
func dataSourceByteplusWafSystemBotsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewWafSystemBotService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceByteplusWafSystemBots())
}
